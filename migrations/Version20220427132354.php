 ...
 */
final class Version20220427132354 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message DROP deleted_at, CHANGE textes textes LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
