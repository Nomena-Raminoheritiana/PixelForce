 ...
 */
final class Version20220426172252 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message ADD created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message DROP created_at, CHANGE textes textes LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
