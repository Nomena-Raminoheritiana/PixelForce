 ...
 */
final class Version20220309125748 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD forgotten_pass_token VARCHAR(255) DEFAULT NULL');
    }
