 ...
 */
final class Version20220410154130 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD id_owner_class_id INT DEFAULT NULL, ADD owner_class_name VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire DROP id_owner_class_id, DROP owner_class_name, CHANGE textes textes LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
