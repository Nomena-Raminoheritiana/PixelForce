 ...
 */
final class Version20220309065451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD six_digit_code INT DEFAULT NULL');
    }
